package click.dailyfeed.member.domain.member.integratedtest.draft;
...
public class MemberDeleteTest {
    ...
    public void fixture__member_delete(
        ...
        Member member = memberRepository.findFirstByEmailFetchJoin(signupRequest.getEmail())
                        .orElseThrow(() -> new MemberNotFoundException());

        authenticationService.deactivate(member.getId());
    }
